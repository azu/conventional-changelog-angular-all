            ...
            .pipe(
                through(function(chunk) {
                    ...
                    expect(chunk).to.include(
                        ", closes [#1](https://github.com/azu/conventional-changelog-angular-all/issues/1) [#2](https://github.com/azu/conventional-changelog-angular-all/issues/2)"
                    );
        ...
        conventionalChangelogCore({
            ...
            .pipe(
                through(function(chunk) {
                    chunk = chunk.toString();
                    expect(chunk).to.include(
                        "[#133](https://github.com/azu/conventional-changelog-angular-all/issues/133)"
                    );
                    done();
                })
            );
        ...
        conventionalChangelogCore({
            ...
            .pipe(
                through(function(chunk) {
                    chunk = chunk.toString();
                    expect(chunk).to.include(
                        "[#88](https://github.com/azu/conventional-changelog-angular-all/issues/88)"
                    );
                    expect(chunk).to.not.include(
                        "closes [#88](https://github.com/azu/conventional-changelog-angular-all/issues/88)"
                    );
                    done();
                })
            );
